...
namespace de.ahzf.Vanaheimr.Balder
{
...

    {
        ...
        /// </summary>
        public VertexSerializerArrow()
		{ }
		
		#endregion

        #region VertexSerializerArrow(MessageRecipients.Recipient, params MessageRecipients.Recipients)
        ...
        public VertexSerializerArrow(MessageRecipient<String> Recipient, params MessageRecipient<String>[] Recipients)
        {
            lock (this)
            {
        ...
        #region VertexSerializerArrow(IArrowReceiver.Recipient, params IArrowReceiver.Recipients)
        ...
        /// <param name="Recipient">A recipient of the processed messages.</param>
        /// <param name="Recipients">The recipients of the processed messages.</param>
        public VertexSerializerArrow(IArrowReceiver<String> Recipient, params IArrowReceiver<String>[] Recipients)
        {
            lock (this)
            {
        ...
        #region ProcessMessage(Vertex, out MessageOut)
