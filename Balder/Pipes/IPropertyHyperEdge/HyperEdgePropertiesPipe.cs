...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The HyperEdgePropertiesPipe returns the property values of the
    ...
    public class HyperEdgePropertiesPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        #region HyperEdgePropertiesPipe(PropertyKeys, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new HyperEdgePropertiesPipe emitting the property values of the
        ...
        public HyperEdgePropertiesPipe(TKeyHyperEdge[] PropertyKeys,
