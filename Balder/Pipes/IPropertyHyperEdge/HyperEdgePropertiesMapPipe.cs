...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The HyperEdgePropertiesMapPipe returns the property values of the
    /// given property keys of the given vertices as an enumeration
    ...
    public class HyperEdgePropertiesMapPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                            TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                            TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                            TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

                                            : AbstractPipe<IPropertyHyperEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                              TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                              TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                              TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>,
                                                           ILookup<TKeyHyperEdge, TValueHyperEdge>>
...

    {
        ...
        private readonly TKeyHyperEdge[] PropertyKeys;
        ...
        #region HyperEdgePropertiesMapPipe(PropertyKeys, IncludeNullValues = false, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new HyperEdgePropertiesMapPipe emitting the property values of the
        ...
        public HyperEdgePropertiesMapPipe(TKeyHyperEdge[] PropertyKeys,
                                          ...
                                          IEnumerator<IPropertyHyperEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                         TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                         TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
        ...
        public override Boolean MoveNext()
        {
            ...
            if (_InternalEnumerator.MoveNext())
            {
                ...
                _CurrentElement = (from   Key
                                   ...
                                   select new KeyValuePair<TKeyHyperEdge, TValueHyperEdge>(Key, PropertyValue)).
