...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class OutVertexPipeExtensions
    {
        ...
        #region OutV(this IEnumerable<IGenericPropertyEdge<...>>, VertexFilter = null)
...

    {
        ...
        #region OutVertexPipe(VertexFilter = null, IEnumerable = null, IEnumerator = null)
        ...
        public OutVertexPipe(VertexFilter                    <TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                              TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                              TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                              TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> VertexFilter = null,
