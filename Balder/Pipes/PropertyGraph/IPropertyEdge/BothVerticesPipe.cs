...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class BothVerticesPipeExtensions
    {
        ...
        #region BothV(this IGenericPropertyEdge<...>)

        /// <summary>
        /// Returns both vertices of the given generic property edge.
        /// </summary>
        ...
        /// <param name="IGenericPropertyEdge">A property edge.</param>
        /// <returns>Both vertices of the given property edge.</returns>
        ...
        #region BothV(this IEnumerable<IGenericPropertyEdge<...>>, VertexFilter = null)

        /// <summary>
        /// Returns both vertices of the given property edges.
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevisionIdVertex">The type of the vertex revision identifiers.</typeparam>
        /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
...

    {
        ...
        #region BothVertices(VertexFilter = null, IEnumerable = null, IEnumerator = null)
        ...
        public BothVerticesPipe(VertexFilter                    <TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                 TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                 TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                 TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> VertexFilter = null,
