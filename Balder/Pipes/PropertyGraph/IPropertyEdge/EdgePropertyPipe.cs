...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The EdgePropertyPipe returns the property values of the
    /// given property key of the given edges.
    /// </summary>
    ...
    public class EdgePropertyPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        private readonly TKeyEdge PropertyKey;

        #endregion

        #region Constructor(s)

        #region EdgePropertyPipe(PropertyKey, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new EdgePropertyPipe emitting the property values of the
        /// given property key of the given edges.
        /// </summary>
        ...
        public EdgePropertyPipe(TKeyEdge PropertyKey,
