...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The MultiEdgePropertyPipe returns the property values of the
    ...
    public class MultiEdgePropertyPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        private readonly TKeyMultiEdge PropertyKey;

        #endregion

        #region Constructor(s)

        #region MultiEdgePropertyPipe(PropertyKey, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new MultiEdgePropertyPipe emitting the property values
        ...
        public MultiEdgePropertyPipe(TKeyMultiEdge PropertyKey,
