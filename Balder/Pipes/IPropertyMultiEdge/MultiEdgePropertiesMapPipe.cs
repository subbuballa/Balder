...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The MultiEdgePropertiesMapPipe returns the property values of the
    ...
    public class MultiEdgePropertiesMapPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                            TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                            TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                            TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

                                            : AbstractPipe<IPropertyMultiEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                              TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                              TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                              TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>,
                                                           ILookup<TKeyMultiEdge, TValueMultiEdge>>
...

    {
        ...
        private readonly TKeyMultiEdge[] PropertyKeys;
        ...
        #region MultiEdgePropertiesMapPipe(PropertyKeys, IncludeNullValues = false, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new MultiEdgePropertiesMapPipe emitting the property values of the
        ...
        public MultiEdgePropertiesMapPipe(TKeyMultiEdge[] PropertyKeys,
                                          ...
                                          IEnumerator<IPropertyMultiEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                         TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                         TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
