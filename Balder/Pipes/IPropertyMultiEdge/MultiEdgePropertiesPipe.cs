...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The MultiEdgePropertiesPipe returns the property values of the
    ...
    public class MultiEdgePropertiesPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        #region MultiEdgePropertiesPipe(PropertyKeys, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new MultiEdgePropertiesPipe emitting the property values of the
        ...
        public MultiEdgePropertiesPipe(TKeyMultiEdge[] PropertyKeys,
