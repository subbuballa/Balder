...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The MultiEdgeLabelPipe will return the labels of the given multiedges.
    /// </summary>
    ...
    public class MultiEdgeLabelPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        #region MultiEdgeLabelPipe(IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new MultiEdgeLabelPipe emitting the labels of the given multiedges.
        /// </summary>
        ...
        public MultiEdgeLabelPipe(IEnumerable<IPropertyMultiEdge<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                 TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                 TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
