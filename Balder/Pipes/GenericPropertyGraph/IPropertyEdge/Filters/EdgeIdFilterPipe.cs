...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class EdgeIdFilterPipeExtensions
    {
        ...
        #region IdFilter(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, EdgeFilter)
        ...
        #region IdEquals(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, Id)
        ...
        /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
        /// <param name="IEnumerable">An enumeration of read-only generic property edges.</param>
        /// <param name="Id">An edge identification to match.</param>
        /// <returns>A filtered enumeration of read-only generic property edges.</returns>
        public static EdgeIdFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                       TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                       TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
...

        {
            ...
            return new EdgeIdFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                        TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                        TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                        TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(EdgeId => EdgeId.Equals(Id), IEnumerable);

        }

        #endregion

        #region IdNotEquals(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, Id)
...

    {
        ...
        #region EdgeIdFilterPipe(EdgeFilter)
        ...
        public EdgeIdFilterPipe(ComparisonFilter<TIdEdge> EdgeFilter,
            ...
            : base(_ => _.Id, EdgeFilter, IEnumerable, IEnumerator)
