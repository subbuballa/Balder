...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class EdgeRevIdFilterPipeExtensions
    {
        ...
        #region RevIdFilter(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, EdgeFilter)
        ...
        public static EdgeRevIdFilterPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                          ...
                                          RevIdFilter<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                      TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                      TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                      TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(
...

    {
        ...
        public EdgeRevIdFilterPipe(ComparisonFilter<TRevIdEdge> EdgeFilter,
            ...
            : base(_ => _.RevId, EdgeFilter, IEnumerable, IEnumerator)
