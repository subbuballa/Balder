...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class BothVerticesPipeExtensions
    {
        ...
        #region BothV(this IEnumerable<IReadOnlyGenericPropertyEdge<...>>, VertexFilter = null)

        /// <summary>
        /// Emit the tail/source and head/target vertices of a generic property edge.
        /// </summary>
        ...
        /// <param name="IEnumerable">An enumeration of generic propertey edges.</param>
        /// <param name="VertexFilter">An optional delegate for vertex filtering.</param>
        /// <returns>Both vertices of the given generic propertey edges.</returns>
