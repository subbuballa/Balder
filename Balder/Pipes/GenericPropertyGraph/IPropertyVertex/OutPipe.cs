...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class OutPipeExtensions
    {
        ...
        #region Out(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>)
        ...
        #region Out(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, EdgeLabel)
        ...
        public override Boolean MoveNext()
        {
            ...
            while (true)
            {
                ...
                else if (_InternalEnumerator.MoveNext())
                {
                    ...
                    if (_UseEdgeLabel)
                        _NextEdges = _InternalEnumerator.Current.OutEdges(_EdgeLabel).GetEnumerator();
                    else
