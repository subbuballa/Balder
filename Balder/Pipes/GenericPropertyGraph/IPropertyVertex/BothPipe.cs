...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class BothPipeExtensions
    {
        ...
        #region Both(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>)

        /// <summary>
        /// Emit the adjacent vertices of the given generic property vertices
        /// reachable via outgoing and incomming edges.
        /// </summary>
        ...
        #region Both(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, EdgeLabel)

        /// <summary>
        /// Emit the adjacent vertices of the given generic property vertices
        /// reachable via outgoing and incomming edges having the given edge label.
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
...

    {
        ...
        #region BothPipe(EdgeLabel, IEnumerable = null, IEnumerator = null)
        ...
        /// <param name="IEnumerable">An optional IEnumerable&lt;...&gt; as element source.</param>
        /// <param name="IEnumerator">An optional IEnumerator&lt;...&gt; as element source.</param>
        public BothPipe(TEdgeLabel EdgeLabel,
