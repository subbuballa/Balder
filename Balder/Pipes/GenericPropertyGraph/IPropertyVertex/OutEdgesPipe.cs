...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class OutEdgesPipeExtensions
    {
        ...
        #region OutE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>)

        /// <summary>
        /// Emit the outgoing edges of a generic property vertex.
        /// </summary>
        ...
        /// <returns>The outgoing edges of the given generic property vertices.</returns>
        ...
        #region OutE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, Label)
        ...
        /// <returns>The outgoing edges of the given generic property vertices having the given edge label.</returns>
        public static OutEdgesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                   TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                   TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                   TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>
...

        {
            ...
            return new OutEdgesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                    TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                    TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                    TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>(EdgeLabel, IEnumerable);
    ...
    public class OutEdgesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                              ...
                              : AbstractEdgesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                  TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                  TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                  TIdHyperEdge, TRevIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>
...

    {
        ...
        #region OutEdgesPipe(EdgeLabel, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Emit the outgoing edges of a generic property vertex
        /// having the given EdgeLabel.
        /// </summary>
        /// <param name="EdgeLabel">The EdgeLabel to traverse.</param>
        /// <param name="IEnumerable">An optional IEnumerable&lt;...&gt; as element source.</param>
        /// <param name="IEnumerator">An optional IEnumerator&lt;...&gt; as element source.</param>
        public OutEdgesPipe(TEdgeLabel EdgeLabel,
