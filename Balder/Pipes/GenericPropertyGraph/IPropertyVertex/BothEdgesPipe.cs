...
namespace de.ahzf.Vanaheimr.Balder
{
    ...
    public static class BothEdgesPipeExtensions
    {
        ...
        #region BothE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>)

        /// <summary>
        /// Emit the outgoing and incomming edges of the given generic property vertices.
        /// </summary>
        ...
        /// <returns>The outgoing and incomming edges of the given generic property vertices.</returns>
        ...
        #region BothE(this IEnumerable<IReadOnlyGenericPropertyVertex<...>>, Label)

        /// <summary>
        /// Emit the outgoing and incomming edges of the given generic
        /// property vertices having the given edge label.
        /// </summary>
        /// <typeparam name="TIdVertex">The type of the vertex identifiers.</typeparam>
        /// <typeparam name="TRevIdVertex">The type of the vertex revision identifiers.</typeparam>
        /// <typeparam name="TVertexLabel">The type of the vertex type.</typeparam>
        ...
        /// <typeparam name="TValueHyperEdge">The type of the hyperedge property values.</typeparam>
        /// <param name="IEnumerable">An enumeration of generic property vertices.</param>
        /// <param name="EdgeLabel">The label of the edges.</param>
        /// <returns>The outgoing and incomming edges of the given generic property vertices.</returns>
        public static BothEdgesPipe<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                    TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                    TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
...

    {
        ...
        #region BothEdgesPipe(EdgeLabel, IEnumerable = null, IEnumerator = null)
        ...
        /// <param name="IEnumerable">An optional IEnumerable&lt;...&gt; as element source.</param>
        /// <param name="IEnumerator">An optional IEnumerator&lt;...&gt; as element source.</param>
        public BothEdgesPipe(TEdgeLabel EdgeLabel,
