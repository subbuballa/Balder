...
namespace de.ahzf.Balder
{
    ...
    public class IdHyperEdgePipe<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
...

    {
        ...
        #region IdHyperEdgePipe(IPropertyGraph, IEnumerable = null, IEnumerator = null)
        ...
        public IdHyperEdgePipe(IPropertyGraph<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                              TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                              TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
        ...
        public override Boolean MoveNext()
        {
            ...
            {
                _CurrentElement = _IPropertyGraph.HyperEdgeById(_InternalEnumerator.Current);
                return true;
            }
