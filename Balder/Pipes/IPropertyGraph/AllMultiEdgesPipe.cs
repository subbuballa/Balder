...
namespace de.ahzf.Balder
{
    ...
    public class AllMultiEdgesPipe<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
...

    {
        ...
        private MultiEdgeFilter<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge> _MultiEdgeFilter;

        private IEnumerator<IPropertyMultiEdge<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                               TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                               TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                               TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>> _MultiEdgeIterator;

        #endregion

        #region Constructor(s)

        #region AllMultiEdgesPipe(MultiEdgeFilter = null, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// This pipe is useful for processing all edges of a graph.
        /// </summary>
        /// <param name="MultiEdgeFilter">A optional delegate for edge filtering.</param>
        ...
        public AllMultiEdgesPipe(MultiEdgeFilter<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                                 TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                 TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
        ...
        {
            _MultiEdgeFilter = MultiEdgeFilter;
        }
        ...
        public override Boolean MoveNext()
        {
            ...
            while (true)
            {
                ...
                if (_MultiEdgeIterator != null && _MultiEdgeIterator.MoveNext())
                {
                    _CurrentElement = _MultiEdgeIterator.Current;
                    return true;
                }

                else if (_InternalEnumerator.MoveNext())
                    _MultiEdgeIterator = _InternalEnumerator.Current.MultiEdges(_MultiEdgeFilter).GetEnumerator();
    ...
    /// This pipe is useful for processing all hyperedges of a graph.
    /// </summary>
    public class AllReadOnlyMultiEdgesPipe<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                           TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                           TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                           TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>
...

    {
        ...
        #region AllReadOnlyMultiEdgesPipe(EdgeFilter = null, IEnumerable = null, IEnumerator = null)
        ...
        /// <param name="IEnumerable">An optional IEnumerable&lt;...&gt; as element source.</param>
        /// <param name="IEnumerator">An optional IEnumerator&lt;...&gt; as element source.</param>
        public AllReadOnlyMultiEdgesPipe(ReadOnlyHyperEdgeFilter<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
                                                                 TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                 TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
