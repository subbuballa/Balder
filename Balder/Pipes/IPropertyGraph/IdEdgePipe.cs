...
namespace de.ahzf.Balder
{
    ...
    public class IdEdgePipe<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
...

    {
        ...
        #region IdEdgePipe(IPropertyGraph, IEnumerable = null, IEnumerator = null)
