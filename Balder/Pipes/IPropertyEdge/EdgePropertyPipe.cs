...
namespace de.ahzf.Balder
{
    ...
    public class EdgePropertyPipe<TIdVertex,    TRevisionIdVertex,    TVertexType,     TKeyVertex,    TValueVertex,
...

    {
        ...
        private readonly TKeyEdge[]            _Keys;
        private          IEnumerator<TKeyEdge> _PropertyEnumerator;

        #endregion

        #region Constructor(s)

        #region EdgePropertyPipe(myKeys, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new EdgePropertyPipe.
        /// </summary>
        /// <param name="myKeys">The property keys.</param>
        public EdgePropertyPipe(TKeyEdge[] myKeys,
            ...
            while (true)
            {
                ...
                if (_PropertyEnumerator == null)
                {
                    ...
                    if (_InternalEnumerator.MoveNext())
                        _PropertyEnumerator = new List<TKeyEdge>(_Keys).GetEnumerator();
