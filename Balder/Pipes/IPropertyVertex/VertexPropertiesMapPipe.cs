...
namespace de.ahzf.Balder
{
    ...
    /// <summary>
    /// The VertexPropertiesMapPipe returns the property values of the
    ...
    public class VertexPropertiesMapPipe<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                         TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                         TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                         TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>

                                      : AbstractPipe<IPropertyVertex<TIdVertex,    TRevisionIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                     TIdEdge,      TRevisionIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                     TIdMultiEdge, TRevisionIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
                                                                     TIdHyperEdge, TRevisionIdHyperEdge, THyperEdgeLabel, TKeyHyperEdge, TValueHyperEdge>,
                                                     ILookup<TKeyVertex, TValueVertex>>
...

    {
        ...
        private readonly TKeyVertex[] PropertyKeys;
        ...
        #region VertexPropertiesMapPipe(PropertyKeys, IncludeNullValues = false, IEnumerable = null, IEnumerator = null)

        /// <summary>
        /// Creates a new VertexPropertiesMapPipe emitting the property values of the
        ...
        public VertexPropertiesMapPipe(TKeyVertex[] PropertyKeys,
        ...
        public override Boolean MoveNext()
        {
            ...
            if (_InternalEnumerator.MoveNext())
            {
                ...
                _CurrentElement = (from   Key
                                   ...
                                   select new KeyValuePair<TKeyVertex, TValueVertex>(Key, PropertyValue)).
